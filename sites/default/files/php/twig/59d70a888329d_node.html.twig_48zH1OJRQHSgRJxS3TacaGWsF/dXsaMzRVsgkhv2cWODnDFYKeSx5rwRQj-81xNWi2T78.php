    ...
    public function block_title_area($context, array $blocks = array())
    {
        ...
        if ( !(isset($context["page"]) ? $context["page"] : null)) {
          ...
          ";
            ...
            // line 97
            echo "            <h2";
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute((isset($context["title_attributes"]) ? $context["title_attributes"] : null), "addClass", array(0 => "node__title title sr-only"), "method"), "html", null, true));
            echo ">
              ";
            // line 98
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, (isset($context["label"]) ? $context["label"] : null), "html", null, true));
...
(isset($context["author_name"]) ? $context["author_name"] : null), "@date" =>             // line 111
(isset($context["date"]) ? $context["date"] : null), ));
    ...
    {
        return new Twig_Source("", "themes/magazine_lite/templates/node.html.twig", "/home/gregory/www/www/themes/magazine_lite/templates/node.html.twig");
    }
}
